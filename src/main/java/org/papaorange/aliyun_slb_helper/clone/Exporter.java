...
public class Exporter {
	...
	public static String exportLoadBalancer(String region, String lbid, boolean genfile) throws IOException {
		...
		response.getListenerPortsAndProtocol().forEach(protocolAndPort -> {
			...
			DescribeListenerAccessControlAttributeResponse laca = SLBHelperAPI
					.describeListenerAccessControlAttr(lbobj.getRegionIdAlias(), lbid, port);
