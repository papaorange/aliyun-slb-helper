...
public class SLBHelperAPI {
	...
	public static DescribeListenerAccessControlAttributeResponse describeListenerAccessControlAttr(String region,
	...
	public static CreateLoadBalancerResponse createLoadBalancer(String loadBalancerName, String loadBalancerSpec,
			String regionId, String masterZoneId, String slaveZoneId, String addressType, String vpcId,
			String vSwitchId, String internetChargeType, Integer bandwidth) {
	...
	public static CreateLoadBalancerHTTPListenerResponse createLoadBalancerHTTPListener(String regionId,
			String loadBalancerId, Integer listenerPort, Integer backendServerPort, String realServerType,
			String realServerId, Integer bandwidth, String scheduler, String healthCheck, Integer healthyThreshold,
			Integer unhealthyThreshold, Integer healthCheckConnectTimeout, Integer healthCheckInterval,
			String healthCheckDomain, String healthCheckURI, String healthCheckHttpCode, Integer healthCheckConnectPort,
			String cookie, Integer cookieTimeout, String stickySession, String stickySessionType, String gzip,
			String xForwardedFor_SLBIP, String xForwardedFor_SLBID, String xForwardedFor_proto, String xForwardedFor) {
	...
	public static CreateLoadBalancerHTTPSListenerResponse createLoadBalancerHTTPSListener(String regionId,
			String loadBalancerId, Integer listenerPort, Integer backendServerPort, String realServerType,
			String realServerId, Integer bandwidth, String scheduler, String healthCheck, Integer healthyThreshold,
			Integer unhealthyThreshold, Integer healthCheckConnectTimeout, Integer healthCheckInterval,
			String healthCheckDomain, String healthCheckURI, String healthCheckHttpCode, Integer healthCheckConnectPort,
	...
	public static CreateLoadBalancerTCPListenerResponse createLoadBalancerTCPListener(String regionId,
			String loadBalancerId, Integer listenerPort, Integer backendServerPort, String realServerType,
			String realServerId, Integer bandwidth, String scheduler, String healthCheckType, Integer healthyThreshold,
			Integer unhealthyThreshold, Integer healthCheckConnectTimeout, Integer healthCheckInterval,
			String healthCheckDomain, String healthCheckURI, String healthCheckHttpCode, Integer presistenceTimeout,
	...
	public static CreateLoadBalancerUDPListenerResponse createLoadBalancerUDPListener(String regionId,
			...
			Integer unhealthyThreshold, Integer healthCheckConnectTimeout, Integer healthCheckInterval,
			Integer healthCheckConnectPort, Integer persistenceTimeout, String healthCheckExp, String healthCheckReq) {
	...
	public static CreateVServerGroupResponse createVServerGroup(String loadBalancerId, String vServerGroupName,
			String regionId,
	...
	public static CreateMasterSlaveVServerGroupResponse createMasterSlaveVServerGroup(String loadBalancerId,
			String msgName, String regionId,
		...
		List<com.aliyuncs.slb.model.v20140515.CreateMasterSlaveServerGroupResponse.MasterSlaveBackendServer> masterSlaveBackendServersCreate = new ArrayList<>();

		msgBackendServers.forEach(msg -> {

			com.aliyuncs.slb.model.v20140515.CreateMasterSlaveServerGroupResponse.MasterSlaveBackendServer tmp = new com.aliyuncs.slb.model.v20140515.CreateMasterSlaveServerGroupResponse.MasterSlaveBackendServer();
